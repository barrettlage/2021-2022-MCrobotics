...
@Autonomous(name="AUTO_BlueL_TeamPark")
public class AUTO_BlueL_TeamPark extends COMP21_Auto_Mecanum_Base {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*
            ...
            After this, the robot will strafe until it is nearby the wall located next to the Team Parking Zone
            on the blue side. After it does that, it will drive forward in order to park fully in the Team
            Parking Zone, after which the program will finish.
