...
@TeleOp(name="Auto_Ball_Launching")
public class Auto_Ball_Launching extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            //The color sensor detects colors close to white,
            if (AutoMode = true && Color1.red()>3 && Color1.blue()>3 && Color1.green()>3) {
                sleep(2000);
                telemetry.addData("Initial Position", LaunchingMotor.getCurrentPosition);
                Current_Position = LaunchingMotor.getCurrentPosition;
                LaunchingMotor.setTargetPosition(Current_Position + 1680);
