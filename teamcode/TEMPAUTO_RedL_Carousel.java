...
public class TEMPAUTO_RedL_Carousel extends COMP21_Auto_Mecanum_Base {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*
            ...
            After depositing the pre-loaded cube, it will strafe over to a certain location, where it will then turn
            to the right. After doing this, it backs up until the Carousel Wheel is touching the actual Carousel, to
            correct any slight errors, it then turns slightly to make sure it is fully lined up with the Carousel.
            Then, it will spin the Carousel for roughly 4 seconds, after which it will then turn to the left, and drive
            forward enough to park partially in the Team Parking Zone.
