...
@Autonomous(name="AUTO_RedL_None_Wait")
public class AUTO_RedL_None_Wait extends COMP21_Auto_Mecanum_Base {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        waitForStart();
            ...
            The difference between this program and the regular one is that at the beginning, after it drives up
            it will wait for a bit to allow another robot, in theory, to complete it's cube task. After this time
            is up it will complete the task and simply park where it is.
