...
@Autonomous(name="blue_power_shot_center")
public class blue_power_shot_center extends LinearOpMode {
...
//        Rotation.setTargetPosition(0);
        ...
        BL.setPower(0.50);
        BR.setPower(0.50);
        FL.setTargetPosition(FL.getCurrentPosition() + 388);
        FR.setTargetPosition(FR.getCurrentPosition() - 388);
        BL.setTargetPosition(BL.getCurrentPosition() - 388);
        BR.setTargetPosition(BR.getCurrentPosition() + 388);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
        ...
        BR.setPower(1.00);
        BL.setPower(1.00);
        FL.setTargetPosition(FL.getCurrentPosition() + 733);
        FR.setTargetPosition(FR.getCurrentPosition() + 733);
        BL.setTargetPosition(BL.getCurrentPosition() + 733);
        BR.setTargetPosition(BR.getCurrentPosition() + 733);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
