...
@Autonomous(name="Red_Auto_TopGoal_Wall")
public class Red_Auto_TopGoal_Wall extends LinearOpMode {
...
sleep(2000);
       ...
       /* public void mcTurn ( double inches, int direction){
            ...
            int target_position_BR;
                ...
                target_position_FL = (FL.getC
            if (direction == 0) {CurrentPosition() - distance_int);
                target_position_FR = (FR.getCurrentPosition() + distance_int);
                target_position_BL = (BL.getCurrentPosition() - distance_int);
                target_position_BR = (BR.getCurrentPosition() + distance_int);
...
*/
        ...
        public void TopGoal () {
            ...
            Flywheel2.setPower(0.95);
            loadingservo.setPosition(0.00);
            telemetry.addData("Loading Ring into Flywheel.", " ");
            telemetry.update();
            sleep(500);
