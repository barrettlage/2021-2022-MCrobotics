...
@Autonomous(name="blue_power_shot_wall")
public class blue_power_shot_wall extends LinearOpMode {
...
//        Rotation.setTargetPosition(0);
        ...
        while (FL.isBusy()||FR.isBusy()||BL.isBusy()||BR.isBusy()) {
            telemetry.addData("FL Position", FL.getCurrentPosition());
            telemetry.addData("FR Posi`ion", FR.getCurrentPosition());
            telemetry.addData("BL Position", BL.getCurrentPosition());
            telemetry.addData("BR Position", BR.getCurrentPosition());
            telemetry.update();
        ...
        BL.setPower(0.50);
        BR.setPower(0.60);
        FL.setTargetPosition(FL.getCurrentPosition()+2100);
        FR.setTargetPosition(FR.getCurrentPosition()-2100);
        BL.setTargetPosition(BL.getCurrentPosition()-2100);
        BR.setTargetPosition(BR.getCurrentPosition()+2100);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
        ...
        BR.setPower(1.00);
        BL.setPower(1.00);
        FL.setTargetPosition(FL.getCurrentPosition()+550);
        FR.setTargetPosition(FR.getCurrentPosition()+550);
        BL.setTargetPosition(BL.getCurrentPosition()+550);
        BR.setTargetPosition(BR.getCurrentPosition()+550);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
