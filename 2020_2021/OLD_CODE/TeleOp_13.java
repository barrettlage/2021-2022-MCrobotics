...
@TeleOp(name="TeleOp_13")
public class TeleOp_13 extends LinearOpMode {
...
//        Rotation.setTargetPosition(0);
        ...
        while (opModeIsActive()) {
            ...
            if (dpad_up1) {
                ...
                Current_Rotation_Position = Current_Rotation_Position - 2700;
                //Rotation.setTargetPosition(-400);
                if(Current_Rotation_Position < 3100) {Current_Rotation_Position = 3100; }
                Rotation.setTargetPosition(Current_Rotation_Position);
            ...
            if (dpad_down1){
                ...
                if(Current_Rotation_Position > 6250) {Current_Rotation_Position = 6250; }
                Rotation.setTargetPosition(Current_Rotation_Position);
                telemetry.addData("New Position", Current_Rotation_Position);
                telemetry.update();
            }
