...
@Autonomous(name="red_power_shot_center")
public class red_power_shot_center extends LinearOpMode {
...
//        Rotation.setTargetPosition(0);
        ...
        sleep(400);
            ...
            /*
            Step 2  -  Strafe Right 6.25 inches (This is still experimental)
            (12.566 is the circumference.) (1.89 rotations for 6.25 inches)
            (725.011 ticks in 6.25 inches) (I rounded to 725)(The bevel gear has a 1:2 ratio, so the ticks need to be doubled)
            */
        FL.setPower(0.50);
        FR.setPower(0.50);
        BL.setPower(0.50);
        BR.setPower(0.50);
        FL.setTargetPosition(FL.getCurrentPosition() - 275);
        FR.setTargetPosition(FR.getCurrentPosition() + 275);
        BL.setTargetPosition(BL.getCurrentPosition() + 275);
        BR.setTargetPosition(BR.getCurrentPosition() - 275);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
        ...
        BL.setPower(0.50);
        BR.setPower(0.50);
        FL.setTargetPosition(FL.getCurrentPosition() - 300);
        FR.setTargetPosition(FR.getCurrentPosition() + 300);
        BL.setTargetPosition(BL.getCurrentPosition() + 300);
        BR.setTargetPosition(BR.getCurrentPosition() - 300);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
        ...
        BL.setPower(0.50);
        BR.setPower(0.50);
        FL.setTargetPosition(FL.getCurrentPosition() - 488);
        FR.setTargetPosition(FR.getCurrentPosition() + 488);
        BL.setTargetPosition(BL.getCurrentPosition() + 488);
        BR.setTargetPosition(BR.getCurrentPosition() - 488);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
        ...
        BR.setPower(1.00);
        BL.setPower(1.00);
        FL.setTargetPosition(FL.getCurrentPosition() + 750);
        FR.setTargetPosition(FR.getCurrentPosition() + 750);
        BL.setTargetPosition(BL.getCurrentPosition() + 750);
        BR.setTargetPosition(BR.getCurrentPosition() + 750);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
